...
group.add_density_option("ldpi", 36)
group.add_density_option("mdpi", 48)
group.add_density_option("hdpi", 72)
group.add_density_option("xhdpi", 96)
group.add_density_option("xxhdpi", 144)
group.add_density_option("xxxhdpi", 192)
