...
group.add_density_option("ldpi", 16)
group.add_density_option("mdpi", 24)
group.add_density_option("hdpi", 36)
group.add_density_option("xhdpi", 48)
group.add_density_option("xxhdpi", 72)
group.add_density_option("xxxhdpi", 96)
